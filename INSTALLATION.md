# INSTALLATION
  ...
  Installing 5 Cube is more straightforward than what it could appear..   
  
  First, if you use Nginx as reversed proxy just point the root of your web app to /path/to/Your5cube/Public   
  ...
  <li>Example of Nginx minimal configuration:
      ...
      server {   
        ...
        server_name yourname-5cube.com;
     
        root /var/www/Your5cube/Public;
        index index.php; 
